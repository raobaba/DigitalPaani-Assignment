        ...
        <div class="flex md:order-2">
          <div class="relative">
            <input
              type="text"
              id="search-navbar"
              class="block w-full p-3 pl-4 pr-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Enter City Name..."
            />
            <svg
              id="search-icon"
              class="absolute w-6 h-6 text-gray-400 top-3 right-3 cursor-pointer"
              aria-hidden="true"
